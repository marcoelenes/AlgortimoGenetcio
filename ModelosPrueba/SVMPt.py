...
columnas_a_cargar = ['SDT', 'pH_CAMPO', 'OD_%', 'TEMP_AMB', 'TEMP_AGUA', 'P_TOT']  # Cambia los nombres según tus columnas
...
X = df.drop(columns=['P_TOT'])  # Todas las columnas excepto 'SST'
y = df['P_TOT']  # La columna 'SST' como variable de salida
...
# Puedes visualizar las predicciones versus las verdaderas etiquetas si lo deseas

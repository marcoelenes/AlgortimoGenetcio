...
X = df.drop(columns=['SST'])  # Todas las columnas excepto 'SST'
y = df['SST']  # La columna 'SST' como variable de salida
...
svr = SVR(kernel='linear')  # Puedes cambiar el kernel si es necesario
